...
Les questions éthiques et légales sont légion. Je parle notamment des actions en justice d'artistes ou bien de Getty Images contre Stability AI/Midjourney, d'auteurs contre OpenAI ou bien encore du New York Times contre OpenAI/Microsoft… <u>Comment ignorer que les données d'entraînement ne sortent pas de nulle part ?</u> Des procès pour violation du droit d'auteur se multiplient, car des pétaoctets de données ont été pompées sans l'accord des ayants droits.
...
<u>Aujourd'hui, avec l'IA, ce décalage n'est plus permis</u>. La peur vient aussi de la méconnaissance des choses. Il est donc vital de :
